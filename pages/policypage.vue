<template>
  <div class="privacy-policy">
    ...
    <p>
      ...
      the choices available to you regarding our use of your Personal Information and how
      you can access and update it.
    </p>
    <p>
      This Policy is a legally binding agreement between you (&#8220;User&#8221;,
      &#8220;you&#8221; or &#8220;your&#8221;) and this Website operator and Mobile
      Application developer (&#8220;Operator&#8221;, &#8220;we&#8221;, &#8220;us&#8221; or
      ...
      to this agreement, in which case the terms &#8220;User&#8221;, &#8220;you&#8221; or
      ...
      the terms of this Policy. This Policy does not apply to the practices of companies
    ...
    <p>
      ...
      individual. If, however, you wish to use some of the features offered on the
      Services, you may be asked to provide certain Personal Information (for example,
      your name and e-mail address).
    </p>
    <p>
      We receive and store any information you knowingly provide to us when you create an
      account, publish content, or fill any forms on the Services. When required, this
    ...
    <p>
      ...
      not be able to take advantage of some of the features on the Services. Users who are
    ...
    <p>
      ...
      through the Services. If you have reason to believe that a child under the age of 18
    ...
    <p>
      ...
      the submitted Personal Information, and such Personal Information is processed only
      in accordance with your instructions. In such instances, the User providing Personal
      Information acts as a data controller.
    </p>
    <p>
      In order to make the Services available to you, or to meet a legal obligation, we
      may need to collect and use certain Personal Information. If you do not provide the
    ...
    <p>
      ...
      given your consent for one or more specific purposes; (ii) provision of information
    ...
    <p>
      ...
      other of the legal bases. In any case, we will be happy to clarify the specific
      legal basis that applies to the processing, and in particular whether the provision
    ...
    <p>
      ...
      Information you can delete may change as the Services change. When you delete
      ...
      to our affiliates and partners, and for the purposes described below. If you would
      like to delete your Personal Information or permanently delete your account, you can
      do so on the settings page of your account on the Services.
    </p>
    <h2 id="disclosure-of-information">Disclosure of information</h2>
    <p>
      To maintain the highest level of privacy and to protect your Personal Information to
      the full extent, we do not share your Personal Information with anyone and for any
      reason.
    </p>
    ...
    <p>
      ...
      you personally. Once the retention period expires, Personal Information shall be
      deleted. Therefore, the right to access, the right to erasure, the right to
    ...
    <p>
      ...
      signals communicated by your browser. Even so, as described in more detail
    ...
    <p>
      The Services contain links to other resources that are not owned or controlled by
      us. Please be aware that we are not responsible for the privacy practices of such
      other resources or third parties. We encourage you to be aware when you leave the
      Services and to read the privacy statements of each and every resource that may
    ...
    <p>
      ...
      our control; (ii) the security, integrity, and privacy of any and all information
      and data exchanged between you and the Services cannot be guaranteed; and (iii) any
    ...
    <p>
      In the event we become aware that the security of the Services has been compromised
    ...
    <p>
      We reserve the right to modify this Policy or its terms related to the Services at
      any time at our discretion. When we do, we will send you an email to notify you. We
      may also provide notice to you in other ways at our discretion, such as through the
    ...
    <p>
      ...
      your consent, use your Personal Information in a manner materially different than
    ...
    <p>
      ...
      to honor your wish to exercise your rights as quickly as possible and in any event,
